                      ...
                      PopupMenuButton<String>(
                        onSelected: (value) async {
                          if (value == 'profile') {
                            ...
                            Future<Future<bool?>> shouldDelete =  showDeleteEventDialog(context, eventData['ticket_id']);
                            if (shouldDelete == true) {
                              // Handle event deletion
                              await deleteEvent(eventData['ticket_id']);
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => SendNotificationPage(eventId: eventData['ticket_id']),
                              ),
                            );
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => EventAttendantsPage(eventId: eventData['ticket_id']),
                              ),
                            );
                          }
                        },
